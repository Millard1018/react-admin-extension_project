                ...
                <div onClick={(event) => event.stopPropagation()} className="fixed top-[12vh] lg:top-[20vh] bottom-[15vh] lg:bottom-[20vh] left-[15vw] right-[15vw] flex flex-col lg:flex-row space-y-[1vh] z-60 lg:text-[1.2em]">
                    ...
                    <div className="bg-slate-100/70 flex-1 lg:h-[60vh] xl:h-[48vh] rounded-2xl flex flex-col lg:ml-2">
                        ...
                        <div className="flex-1 flex justify-end items-end">
                            <button className="hidden bg-green-800 text-start text-slate-100 rounded-2xl p-1 px-2 m-1 hover:opacity-70 active:bg-white active:text-slate-900" id="recieptButton" >Reciept</button>
                            <button className="hidden bg-green-800 text-start text-slate-100 rounded-2xl p-1 px-2 m-1 hover:opacity-70 active:bg-white active:text-slate-900" id="initialClaim" onClick="confirmationBox()">Claim</button>
                    ...
                    <div id = "confirmationBlur" className = "invisible z-50 w-screen h-[120vh] fixed left-0 top-0 bg-gray-500/10 opacity-70 backdrop-blur-xs overflow-hidden" onClick="closeConfirmation()"></div>
                    <div id="shadow" className="z-60 invisible fixed right-[25.5vw] left-[25.5vw] top-[35vh] bottom-[37vh] lg:top-[35vh] lg:bottom-[35vh] lg:right-[35vw] lg:left-[35vw] bg-gray-200/60 shadow-2xl opacity-60 backdrop-blur-xs border-2 border-white rounded-4xl p-1"></div>
                    <div id="box" className="z-60 invisible fixed right-[27vw] left-[27vw] top-[37vh] bottom-[39vh] lg:top-[38vh] lg:bottom-[38vh] lg:right-[36vw] lg:left-[36vw] flex flex-col justify-center items-center bg-white rounded-4xl shadow-2xl">
                        ...
                        <div>
                            <p className="mt-[1vh] font-bold">Confirm claim for <br/><span id="modalConfirm" className="flex justify-center"></span></p>
                        </div>
                        <div className="mt-[2vh] flex w-full justify-between px-[6vw] xl:px-[8vw]">
                            <button className="border-2 border-gray-500 rounded-xl p-1 hover:opacity-60 active:opacity-100" onClick="closeConfirmation()">Cancel</button>
                            <button className="border-2 border-blue-900 bg-blue-800 rounded-xl p-1 px-2 hover:opacity-60 active:opacity-100" id="claimButton" onClick="closeConfirmation()">Claim</button>
                        </div>
                    </div>
                </div>
            </div>
